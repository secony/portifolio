...
Esse portfólio foi criado para ser simples, claro e direto.
A ideia nunca foi impressionar com exagero, mas mostrar evolução, organização e vontade de aprender.
...
Para acompanhar minha evolução na programação

Para centralizar meus projetos em um só lugar
...
Trabalhar melhor acessibilidade
